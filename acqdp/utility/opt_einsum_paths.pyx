...
from . import opt_einsum_helpers as helpers
...
def calc_k12_flops(inputs, output, remaining, int i, int j, size_dict):
    """
...
def _get_candidate(output, sizes, remaining, footprints, dim_ref_counts, k1, k2, cost_fn):
    ...
    return (cost, id2, id1), k1, k2, k12  # break ties to ensure determinism
