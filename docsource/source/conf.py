...
project = 'Alibaba Cloud Quantum Development Platform'
copyright = '2020, Alibaba Quantum Laboratory'
author = 'Cupjin Huang, Mario Szegedy, Fang Zhang and Jianxin Chen'
...
latex_documents = [
    (master_doc, 'ACQDP.tex', 'ACQDP Documentation',
     'Cupjin Huang, Mario Szegedy, Fang Zhang and Jianxin Chen', 'manual'),
]
...
man_pages = [
    (master_doc, 'ACQDP', 'ACQDP Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ACQDP', 'ACQDP(授渔) Documentation',
     author, 'ACQDP', 'One line description of project.',
     'Miscellaneous'),
]
